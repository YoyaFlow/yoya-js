/**
 * Dynamic Loader Demo Entry Point
 */
import { createDynamicLoaderPage } from './dynamic-loader.js';
...
// 创建并渲染页面
const dynamicLoaderPage = createDynamicLoaderPage();
dynamicLoaderPage.bindTo('#app');
